                    ...
                    <div class="row card-body">
                        <div class="col-12">
                            <div class="table-responsive">
                                ...
                                !-- Modal Historial de Cambios de Habitación -->
                <el-dialog
                ...
                >
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in JSON.parse(this.currentRent.history).historial" :key="index">
                                    <td>{{ index + 1 }}</td>
                                    <td>{{ item.name }}</td>
                                    <td>{{ item.quantity }}</td>
                                    <td>{{ item.date }}</td>
                                ...
                                <tr v-if="!JSON.parse(this.currentRent.history).historial || JSON.parse(this.currentRent.history).historial.length === 0">
...
export default {
    ...
    methods: {
        ...
        async onGoToInvoice() {
            ...
            this.document.sale_notes_relateds = this.selectedHistoryItems.map(item => item.sale_note_id);
            this.$http
