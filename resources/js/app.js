...
Vue.component('tenant-certificates-qztray', require('./views/tenant/companies/certificates_qztray/index.vue'));
...
Vue.component('tenant-options-form-item', require('./views/tenant/options/form_item.vue'));
...
Vue.component('tenant-dispatch-addresses-index', require('./views/tenant/dispatches/dispatch-addresses/index'));
...
// Sire
Vue.component('tenant-sire-index', require('./views/tenant/sire/index.vue'));

// Sire
Vue.component('tenant-qr-chat', require('@viewsModuleQrChatBuho/Configuration.vue'));
